// Created 04/26/04 by Demiurge Studios
// Handles smoke and explosion effects when the LoungeTank blows up.
// Also handles spawning tiny parts of the vehicle that go
// flying away from the explosion.

class LoungeTankDeath extends Emitter;

#exec OBJ LOAD FILE="..\Textures\ExplosionTex.utx"
#exec OBJ LOAD FILE="..\StaticMeshes\CS_DeadVehicles_S.usx"
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'Clones.LoungeTankDeath.SpriteEmitter000'
     ...
     End Object
     Emitters(1)=SpriteEmitter'Clones.LoungeTankDeath.SpriteEmitter001'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter002
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(2)=SpriteEmitter'Clones.LoungeTankDeath.SpriteEmitter002'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter003
         ...
         LifetimeRange=(Min=0.500000,Max=0.500000)
     End Object
     Emitters(3)=SpriteEmitter'Clones.LoungeTankDeath.SpriteEmitter003'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter004
         ...
         LifetimeRange=(Min=0.500000,Max=0.500000)
     End Object
     Emitters(4)=SpriteEmitter'Clones.LoungeTankDeath.SpriteEmitter004'

     Begin Object Class=MeshEmitter Name=MeshEmitter000
         StaticMesh=StaticMesh'CS_DeadVehicles_S.TankDead.BigWheel'
     ...
     End Object
     Emitters(5)=MeshEmitter'Clones.LoungeTankDeath.MeshEmitter000'

     Begin Object Class=MeshEmitter Name=MeshEmitter001
         StaticMesh=StaticMesh'CS_DeadVehicles_S.TankDead.Flamingo1'
         UseMeshBlendMode=False
         UseParticleColor=True
         UseCollision=True
         UseColorScale=True
         ...
         MaxParticles=1
         DetailMode=DM_High
         StartLocationOffset=(X=-120.000000,Z=400.000000)
         UseRotationFrom=PTRS_Actor
         SpinsPerSecondRange=(X=(Max=0.300000),Y=(Max=0.300000),Z=(Max=0.300000))
         StartSpinRange=(X=(Max=1.000000))
         InitialParticlesPerSecond=500.000000
         ...
         StartVelocityRange=(X=(Min=150.000000,Max=200.000000),Y=(Min=-300.000000,Max=300.000000),Z=(Min=400.000000,Max=900.000000))
     End Object
     Emitters(6)=MeshEmitter'Clones.LoungeTankDeath.MeshEmitter001'

     Begin Object Class=MeshEmitter Name=MeshEmitter002
         StaticMesh=StaticMesh'CS_DeadVehicles_S.TankDead.Gun'
         UseCollision=True
         UseColorScale=True
         RespawnDeadParticles=False
         SpinParticles=True
         ...
         InitialParticlesPerSecond=500.000000
         DrawStyle=PTDS_AlphaBlend
         StartVelocityRange=(X=(Min=-150.000000,Max=150.000000),Y=(Min=-300.000000,Max=300.000000),Z=(Min=500.000000,Max=1000.000000))
     End Object
     Emitters(7)=MeshEmitter'Clones.LoungeTankDeath.MeshEmitter002'

...
// Handles smoke and explosion effects when the RocketBike blows up.
// Also handles spawning tiny parts of the vehicle that go
// flying away from the explosion.

class RocketBikeDeath extends Emitter;
...
defaultproperties
{
     ...
     End Object
     Emitters(0)=SpriteEmitter'Clones.RocketBikeDeath.SpriteEmitter000'
     ...
     End Object
     Emitters(1)=SpriteEmitter'Clones.RocketBikeDeath.SpriteEmitter001'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter002
         ...
         GetVelocityDirectionFrom=PTVD_AddRadial
     End Object
     Emitters(2)=SpriteEmitter'Clones.RocketBikeDeath.SpriteEmitter002'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter003
         ...
         LifetimeRange=(Min=0.500000,Max=0.500000)
     End Object
     Emitters(3)=SpriteEmitter'Clones.RocketBikeDeath.SpriteEmitter003'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter004
         ...
         LifetimeRange=(Min=0.500000,Max=0.500000)
     End Object
     Emitters(4)=SpriteEmitter'Clones.RocketBikeDeath.SpriteEmitter004'

     Begin Object Class=MeshEmitter Name=MeshEmitter000
         StaticMesh=StaticMesh'CS_DeadVehicles_S.RocketBikeDead.Tail'
         ...
         InitialParticlesPerSecond=500.000000
         DrawStyle=PTDS_AlphaBlend
         StartVelocityRange=(X=(Min=-200.000000,Max=-600.000000),Y=(Min=-500.000000,Max=500.000000),Z=(Min=100.000000,Max=100.000000))
     End Object
     Emitters(5)=MeshEmitter'Clones.RocketBikeDeath.MeshEmitter000'

     Begin Object Class=MeshEmitter Name=MeshEmitter001
         StaticMesh=StaticMesh'CS_DeadVehicles_S.RocketBikeDead.Wheel'
         UseMeshBlendMode=False
         UseParticleColor=True
         UseCollision=True
         UseColorScale=True
         ...
         InitialParticlesPerSecond=500.000000
         DrawStyle=PTDS_AlphaBlend
         StartVelocityRange=(X=(Min=150.000000,Max=250.000000),Y=(Min=-300.000000,Max=300.000000),Z=(Min=100.000000,Max=200.000000))
     End Object
     Emitters(6)=MeshEmitter'Clones.RocketBikeDeath.MeshEmitter001'
